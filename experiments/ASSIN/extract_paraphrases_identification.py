...
from src.data.nli import AssinTransformersDataset
...
parser.add_argument("--pretrained_name_or_path", type=str,
                    default="/home/matej/Documents/paraphrase-nli/models/ASSIN/assin-bert-base-portuguese-cased-2e-5-maxlength61")
parser.add_argument("--model_type", type=str, default="bert",
                    choices=["bert", "roberta", "xlm-roberta"])
parser.add_argument("--max_seq_len", type=int, default=61)
...
if __name__ == "__main__":
    ...
    for dataset_name in ["train", "validation", "test"]:
        dataset = AssinTransformersDataset(dataset_name, tokenizer=tokenizer,
        ...
        # To obtain challenging non-paraphrases, we use (ent, neutral) pairs
        OTHER_LABEL = "neutral"
