...
if __name__ == "__main__":
    ...
    train_set = AssinTransformersDataset("train", tokenizer=tokenizer,
                                         max_length=args.max_seq_len, return_tensors="pt")
    dev_set = AssinTransformersDataset("validation", tokenizer=tokenizer,
                                       max_length=args.max_seq_len, return_tensors="pt")
    test_set = AssinTransformersDataset("test", tokenizer=tokenizer,
                                        max_length=args.max_seq_len, return_tensors="pt")
    ...
    # class weights: approx. 2.7x more non-entailment than entailment examples
