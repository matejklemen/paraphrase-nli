...
from src.data.paraphrase import MSCOCOTransformersDataset
...
parser.add_argument("--use_cpu", action="store_true", default=True)  # TODO
...
if __name__ == "__main__":
    ...
    train_set = MSCOCOTransformersDataset(args.train_path, tokenizer=tokenizer,
                                          max_length=args.max_seq_len, return_tensors="pt",
                                          reverse_order=args.reverse_order)
    dev_set = MSCOCOTransformersDataset(args.dev_path, tokenizer=tokenizer,
                                        max_length=args.max_seq_len, return_tensors="pt",
                                        reverse_order=args.reverse_order)
    test_set = MSCOCOTransformersDataset(args.test_path, tokenizer=tokenizer,
                                         max_length=args.max_seq_len, return_tensors="pt",
                                         reverse_order=args.reverse_order)
