...
if __name__ == "__main__":
    ...
    for curr_handle_or_obj in processed_datasets:
        ...
        logging.info(f"Left-to-right: {len(ent_inds)} entailments")
        ...
        rev_ent_mask = torch.eq(reverse_res["pred_label"], dataset.label2idx["entailment"])
        ...
        logging.info(f"Right-to-left: {len(rev_ent_inds)} paraphrases found!")
