...
parser.add_argument("--pretrained_name_or_path", type=str,
                    default="wmt14-de-en-bitext-xlm-roberta-base-2e-5-maxlength129")
...
parser.add_argument("--train_path", type=str, help="Path to the training set of WMT14 (tsv)", default=None)
parser.add_argument("--dev_path", type=str, help="Path to the validation set of WMT14 (tsv)", default=None)
parser.add_argument("--test_path", type=str, help="Path to the test set of WMT14 (tsv)", default=None)
...
if __name__ == "__main__":
    ...
    for dataset_name, data_path in [("train", args.train_path), ("dev", args.dev_path), ("test", args.test_path)]:
        ...
        dataset = WMT14TransformersDataset(data_path, tokenizer=tokenizer,
