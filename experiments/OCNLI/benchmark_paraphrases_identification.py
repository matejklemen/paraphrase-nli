...
parser.add_argument("--paraphrase_path", type=str,
					default="/home/matej/Documents/paraphrase-nli/experiments/OCNLI/PARAPHRASE_IDENTIFICATION/id-ocnli-chinese-roberta-wwm-ext-argmax/all_para_id.csv")
parser.add_argument("--pretrained_name_or_path", type=str, default="hfl/chinese-roberta-wwm-ext")
