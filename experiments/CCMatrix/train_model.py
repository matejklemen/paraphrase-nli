...
from src.data.bitext import CCMatrixTransformersDataset
...
parser.add_argument("--train_path", type=str, help="Path to training set of CCMatrix (tsv)",
                    default="id_ccmatrix_nl-sl_bitext_train_mixeddir.tsv")
parser.add_argument("--dev_path", type=str, help="Path to dev set of CCMatrix (tsv)",
                    default="id_ccmatrix_nl-sl_bitext_dev_mixeddir.tsv")
parser.add_argument("--test_path", type=str, help="Path to test set of CCMatrix (tsv)",
                    default="id_ccmatrix_nl-sl_bitext_test_mixeddir.tsv")
...
if __name__ == "__main__":
    ...
    train_set = CCMatrixTransformersDataset(args.train_path, tokenizer=tokenizer,
                                            max_length=args.max_seq_len, return_tensors="pt",
                                            reverse_order=args.reverse_order,
                                            nrows=args.nrows)
    dev_set = CCMatrixTransformersDataset(args.dev_path, tokenizer=tokenizer,
                                          max_length=args.max_seq_len, return_tensors="pt",
                                          reverse_order=args.reverse_order)
    test_set = CCMatrixTransformersDataset(args.test_path, tokenizer=tokenizer,
                                           max_length=args.max_seq_len, return_tensors="pt",
                                           reverse_order=args.reverse_order)
