...
parser.add_argument("--train_path", type=str, help="Path to training set of KAS (tsv)",
                    default="/home/matej/Documents/paraphrase-nli/experiments/KAS_bitext/id_kas_bitext_train.tsv")
parser.add_argument("--dev_path", type=str, help="Path to dev set of KAS (tsv)",
                    default="/home/matej/Documents/paraphrase-nli/experiments/KAS_bitext/id_kas_bitext_dev.tsv")
parser.add_argument("--test_path", type=str, help="Path to test set of KAS (tsv)",
                    default="/home/matej/Documents/paraphrase-nli/experiments/KAS_bitext/id_kas_bitext_test.tsv")

parser.add_argument("--num_epochs", type=int, default=2)
parser.add_argument("--max_seq_len", type=int, default=114)
...
if __name__ == "__main__":
    ...
    train_set = KASTransformersDataset(args.train_path, tokenizer=tokenizer,
                                       max_length=args.max_seq_len, return_tensors="pt",
                                       reverse_order=args.reverse_order)
    dev_set = KASTransformersDataset(args.dev_path, tokenizer=tokenizer,
                                     max_length=args.max_seq_len, return_tensors="pt",
                                     reverse_order=args.reverse_order)
    test_set = KASTransformersDataset(args.test_path, tokenizer=tokenizer,
                                      max_length=args.max_seq_len, return_tensors="pt",
                                      reverse_order=args.reverse_order)
